...
ALIENMAXSPEED = 4
ADDNEWALIENRATE = 40
ADDNEWALIEN1RATE = 400
ADDSUPERALIENRATE = 2000
PLAYERMOVERATE = 5
ALIENSIZE = 50
BULLETSPEED = 8
NOSUPERBULLETS = 5
...
pygame.mixer.music.load('C:/Users/mech/Desktop/THE WAR/starboy.mp3')
...
drawText('THE WAR',font, windowSurface, (WINDOWWIDTH / 3), (WINDOWHEIGHT / 3))
drawText('Press any key to GET STARTED!!', font, windowSurface, (WINDOWWIDTH / 4) - 30, (WINDOWHEIGHT / 3) + 50)
...
while True:
	...
	while True: # the game loop runs while the game part is playing
		...
		for event in pygame.event.get():
			...
			if event.type == KEYDOWN:
				...
				if event.key == K_SPACE:
					# create new 's if space is pressed
					newSpaceshipBullet1 = pygame.Rect(playerRect.centerx-20, playerRect.centery+5, 3, 20)
					spaceshipBullets.append(newSpaceshipBullet1)
					newSpaceshipBullet2 = pygame.Rect(playerRect.centerx+15, playerRect.centery+5, 3, 20)
		...
		# draw the bullets	
		for b in spaceshipBullets:
			pygame.draw.rect(windowSurface, (255, 0, 0), b, 0)
